...
namespace projAndreTurismoApp.CityService.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CitiesController : ControllerBase
    {
        private readonly projAndreTurismoAppCityServiceContext _context;

        public CitiesController(projAndreTurismoAppCityServiceContext context)
        {
            _context = context;
        }
